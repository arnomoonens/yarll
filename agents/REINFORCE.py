...
#         if rank == 1:
#             agent = REINFORCEDiscrete(env, action_selection, args.rnn, **shared_args)
#         else:
#             agent = REINFORCEDiscreteCNN(env, action_selection, **shared_args)
#     elif isinstance(env.action_space, Box):
#         action_selection = ContinuousActionSelection()
#         if rank == 1:
#             agent = REINFORCEContinuous(env, action_selection, args.rnn, **shared_args)
#         else:
